package com.kishku7.TerraK7.paralithic.functions.natives;
...
import com.kishku7.TerraK7.seismic.algorithms.string.StringAlgorithms;
import com.kishku7.TerraK7.seismic.util.ReflectionUtils;
        ...
        try(InputStream inputStream = Parser.class.getClassLoader().getResourceAsStream("META-INF/CLASS_MANIFEST_seismic")) {
            ...
            try(BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream))) {
                ...
                while((line = reader.readLine()) != null) {
                    if(line.startsWith("com.kishku7.TerraK7.seismic.math")) {
