...
sourceSets {
    named("main") {
        java {
            srcDir("../shared_minecraft/mixin-common/src/main/java")
            srcDir("../shared_minecraft/mixin-lifecycle/src/main/java")
        }
        resources {
            srcDir("../shared_minecraft/mixin-common/src/main/resources")
            srcDir("../shared_minecraft/mixin-lifecycle/src/main/resources")
        }
    }
}

dependencies {
    shadedApi(project(":shared_common:implementation:base"))
...
loom {
    accessWidenerPath.set(file("../shared_minecraft/mixin-common/src/main/resources/terra.accesswidener"))
