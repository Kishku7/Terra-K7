...
public class EventManagerImpl implements EventManager {
    ...
    public EventManagerImpl() {
        handlers.put(FunctionalEventHandler.class, new FunctionalEventHandlerImpl()); // default handler (direct put avoids invoking an overridable method during construction)
    }
